...
export function Footer() {
  ...
  // Mensagem para o botão do número de telefone geral
  ...
  // Mensagem padronizada para o link de Encomendas Especiais
  ...
  return (
    <section id="contato" className="bg-roxo-escuro text-white/90 pt-16 pb-8 border-t-[6px] border-dourado-accent relative">
      <footer className="bg-roxo-escuro text-white/90 pt-16 pb-8 border-t-[6px] border-dourado-accent relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <address className="not-italic flex flex-col gap-4 text-sm text-white/80">
                <div className="flex items-start gap-3">
                  ...
                  <p>
                    <strong>Sede em Indaiatuba - SP</strong><br />
                    <span className="text-white/60 text-xs">
                      Entregas expressas para Campinas e Região Metropolitana.<br />
            ...
            <div className="flex flex-col gap-4">
              ...
              <nav className="flex flex-col gap-2 text-sm text-white/80">
                <a href="#produtos" className="hover:text-dourado-accent transition-colors w-fit">Nossas Essências</a>
                <a href="#depoimentos" className="hover:text-dourado-accent transition-colors w-fit">Avaliações de Clientes</a>
                <button 
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-white/50">
            <p>
              &copy; {anoAtual} MM Parfum. Todos os direitos reservados.
            </p>
